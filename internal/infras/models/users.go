...
var UserWhere = struct {
	...
	ID:        whereHelperint{field: "\"crud\".\"users\".\"id\""},
	Name:      whereHelperstring{field: "\"crud\".\"users\".\"name\""},
	Email:     whereHelpernull_String{field: "\"crud\".\"users\".\"email\""},
	CreatedAt: whereHelpertime_Time{field: "\"crud\".\"users\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"crud\".\"users\".\"updated_at\""},
	DeletedAt: whereHelpernull_Time{field: "\"crud\".\"users\".\"deleted_at\""},
}
...
var (
	...
	userColumnsWithDefault    = []string{"id", "email", "created_at", "updated_at", "deleted_at"}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"crud\".\"users\""), qmhelper.WhereIsNull("\"crud\".\"users\".\"deleted_at\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"crud\".\"users\".*"})
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"crud\".\"users\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"crud\".\"users\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"crud\".\"users\" %sDEFAULT VALUES%s"
		}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"crud\".\"users\" SET %s WHERE %s",
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"crud\".\"users\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"crud\".\"users\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"crud\".\"users\" WHERE \"id\"=$1"
	} else {
		currTime := time.Now().In(boil.GetLocation())
		o.DeletedAt = null.TimeFrom(currTime)
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"crud\".\"users\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"crud\".\"users\" WHERE " +
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"crud\".\"users\" SET %s WHERE "+
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"crud\".\"users\".* FROM \"crud\".\"users\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o)) +
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"crud\".\"users\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
